...
class TestFindProductWithHighestRevenue {
	@Test
	void testEmptySalesData() {
		SalesData salesData = new SalesData();
		assertEquals("null,null,null", salesData.findProductWithHighestRevenue());
	}
	...
	void testOneProduct() {
		...
		assertEquals("HEINZ KETCHUP 38 OZ,11.97,3", salesData.findProductWithHighestRevenue());
	}
	...
	void testOneProductWithZeroRevenue() {
		...
		assertEquals("KOOL AID ORANGE 2 QT,0.0,57", salesData.findProductWithHighestRevenue());
	}
	...
	void testHighestRevenueFirstAmongMultipleProducts() {
		...
		assertEquals("KOOL AID ORANGE 2 QT,18.81,57", salesData.findProductWithHighestRevenue());
	}
