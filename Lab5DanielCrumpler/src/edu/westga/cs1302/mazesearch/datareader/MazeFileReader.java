...
public class MazeFileReader {
	 ...
	 * cell(i,j) is a 4-bit representation of the 4 walls of the cell in row i and
	 * column j: Bit representing 1 is on: cell has left wall Bit representing 2 is
	 * on: cell has upper wall Bit representing 4 is on: cell has right wall Bit
	 * representing 8 is on: cell has lower wall
	 * 
